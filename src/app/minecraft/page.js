            ...
            <div className="w-full max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-4 items-center">
                ...
                <div className="flex flex-col gap-6 lg:pl-8">
                  ...
                  <FadeIn delay={0.15}>
                    <p className="text-gray-400 text-lg leading-relaxed">With 5+ years in Minecraft server development, I&apos;ve built everything from intimate survival worlds to large-scale competitive networks serving thousands of concurrent players.</p>
                    <p className="text-gray-500 leading-relaxed mt-4">Every plugin I build is designed to feel native — as if it was always part of the game.</p>
                  </FadeIn>
                  <FadeIn delay={0.25}>
